...
\renewcommand\soustitre{Rapport de projet - groupe grtt6}
...
\begin{document}
	...
	\chapter{Difficultés rencontrées}  
		...
		\section{Date de réservation dans l'application}
		\input{textes/dateReservation}
